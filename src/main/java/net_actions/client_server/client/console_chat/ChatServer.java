package net_actions.client_server.client.console_chat; /**
...
public class ChatServer {
    ...
    private Socket getNewConn() {
        ...
        try {
            s = ss.accept();
            System.out.println("Server start at the: " + s.getInetAddress() + ":" + s.getPort());
        } catch (IOException e) {
    ...
    public static void main(String[] args) throws IOException {
        new ChatServer(22222).run(); // если сервер не создался, программа
